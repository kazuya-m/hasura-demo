...
export type Mutation_Root = {
  ...
  /** delete data from the table: "prifile_user" */
  delete_prifile_user?: Maybe<Prifile_User_Mutation_Response>;
  /** delete single row from the table: "prifile_user" */
  delete_prifile_user_by_pk?: Maybe<Prifile_User>;
  ...
  /** insert data into the table: "prifile_user" */
  insert_prifile_user?: Maybe<Prifile_User_Mutation_Response>;
  /** insert a single row into the table: "prifile_user" */
  insert_prifile_user_one?: Maybe<Prifile_User>;
  ...
  /** update data of the table: "prifile_user" */
  update_prifile_user?: Maybe<Prifile_User_Mutation_Response>;
  /** update single row of the table: "prifile_user" */
  update_prifile_user_by_pk?: Maybe<Prifile_User>;
...
/** mutation root */
export type Mutation_RootDelete_Prifile_UserArgs = {
  where: Prifile_User_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Prifile_User_By_PkArgs = {
  id: Scalars['uuid'];
};
...
/** mutation root */
export type Mutation_RootInsert_Prifile_UserArgs = {
  objects: Array<Prifile_User_Insert_Input>;
  on_conflict?: Maybe<Prifile_User_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Prifile_User_OneArgs = {
  object: Prifile_User_Insert_Input;
  on_conflict?: Maybe<Prifile_User_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Prifile_UserArgs = {
  _set?: Maybe<Prifile_User_Set_Input>;
  where: Prifile_User_Bool_Exp;
};


/** mutation root */
export type Mutation_RootUpdate_Prifile_User_By_PkArgs = {
  _set?: Maybe<Prifile_User_Set_Input>;
  pk_columns: Prifile_User_Pk_Columns_Input;
};
...
/** columns and relationships of "prifile_user" */
export type Prifile_User = {
  __typename?: 'prifile_user';
  id: Scalars['uuid'];
...
/** aggregated selection of "prifile_user" */
export type Prifile_User_Aggregate = {
  __typename?: 'prifile_user_aggregate';
  aggregate?: Maybe<Prifile_User_Aggregate_Fields>;
  nodes: Array<Prifile_User>;
};

/** aggregate fields of "prifile_user" */
export type Prifile_User_Aggregate_Fields = {
  __typename?: 'prifile_user_aggregate_fields';
  count: Scalars['Int'];
  max?: Maybe<Prifile_User_Max_Fields>;
  min?: Maybe<Prifile_User_Min_Fields>;
};


/** aggregate fields of "prifile_user" */
export type Prifile_User_Aggregate_FieldsCountArgs = {
  columns?: Maybe<Array<Prifile_User_Select_Column>>;
  distinct?: Maybe<Scalars['Boolean']>;
};

/** order by aggregate values of table "prifile_user" */
export type Prifile_User_Aggregate_Order_By = {
  count?: Maybe<Order_By>;
  max?: Maybe<Prifile_User_Max_Order_By>;
  min?: Maybe<Prifile_User_Min_Order_By>;
};

/** input type for inserting array relation for remote table "prifile_user" */
export type Prifile_User_Arr_Rel_Insert_Input = {
  data: Array<Prifile_User_Insert_Input>;
  /** on conflict condition */
  on_conflict?: Maybe<Prifile_User_On_Conflict>;
};

/** Boolean expression to filter rows from the table "prifile_user". All fields are combined with a logical 'AND'. */
export type Prifile_User_Bool_Exp = {
  _and?: Maybe<Array<Prifile_User_Bool_Exp>>;
  _not?: Maybe<Prifile_User_Bool_Exp>;
  _or?: Maybe<Array<Prifile_User_Bool_Exp>>;
  id?: Maybe<Uuid_Comparison_Exp>;
...
/** unique or primary key constraints on table "prifile_user" */
export enum Prifile_User_Constraint {
  /** unique or primary key constraint */
  PrifileUserPkey = 'prifile_user_pkey'
}

/** input type for inserting data into table "prifile_user" */
export type Prifile_User_Insert_Input = {
  id?: Maybe<Scalars['uuid']>;
...
/** aggregate max on columns */
export type Prifile_User_Max_Fields = {
  __typename?: 'prifile_user_max_fields';
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by max() on columns of table "prifile_user" */
export type Prifile_User_Max_Order_By = {
  id?: Maybe<Order_By>;
...
/** aggregate min on columns */
export type Prifile_User_Min_Fields = {
  __typename?: 'prifile_user_min_fields';
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by min() on columns of table "prifile_user" */
export type Prifile_User_Min_Order_By = {
  id?: Maybe<Order_By>;
  profile_id?: Maybe<Order_By>;
  user_id?: Maybe<Order_By>;
};

/** response of any mutation on the table "prifile_user" */
export type Prifile_User_Mutation_Response = {
  __typename?: 'prifile_user_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Prifile_User>;
};

/** on conflict condition type for table "prifile_user" */
export type Prifile_User_On_Conflict = {
  constraint: Prifile_User_Constraint;
  update_columns?: Array<Prifile_User_Update_Column>;
  where?: Maybe<Prifile_User_Bool_Exp>;
};

/** Ordering options when selecting data from "prifile_user". */
export type Prifile_User_Order_By = {
  id?: Maybe<Order_By>;
...
/** primary key columns input for table: prifile_user */
export type Prifile_User_Pk_Columns_Input = {
  id: Scalars['uuid'];
};

/** select columns of table "prifile_user" */
export enum Prifile_User_Select_Column {
  /** column name */
  Id = 'id',
  /** column name */
...
/** input type for updating data in table "prifile_user" */
export type Prifile_User_Set_Input = {
  id?: Maybe<Scalars['uuid']>;
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** update columns of table "prifile_user" */
export enum Prifile_User_Update_Column {
  /** column name */
  Id = 'id',
  /** column name */
  ProfileId = 'profile_id',
...
export type Profiles = {
  ...
  prifile_users: Array<Prifile_User>;
  /** An aggregate relationship */
  prifile_users_aggregate: Prifile_User_Aggregate;
  /** An object relationship */
  user: Users;
};
...
/** columns and relationships of "profiles" */
export type ProfilesPrifile_UsersArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
  where?: Maybe<Prifile_User_Bool_Exp>;
};


/** columns and relationships of "profiles" */
export type ProfilesPrifile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
export type Profiles_Bool_Exp = {
  ...
  prifile_users?: Maybe<Prifile_User_Bool_Exp>;
  user?: Maybe<Users_Bool_Exp>;
};
...
export type Profiles_Insert_Input = {
  ...
  prifile_users?: Maybe<Prifile_User_Arr_Rel_Insert_Input>;
  user?: Maybe<Users_Obj_Rel_Insert_Input>;
};
...
export type Profiles_Order_By = {
  ...
  prifile_users_aggregate?: Maybe<Prifile_User_Aggregate_Order_By>;
  user?: Maybe<Users_Order_By>;
};
...
export type Query_Root = {
  ...
  /** fetch data from the table: "prifile_user" */
  prifile_user: Array<Prifile_User>;
  /** fetch aggregated fields from the table: "prifile_user" */
  prifile_user_aggregate: Prifile_User_Aggregate;
  /** fetch data from the table: "prifile_user" using primary key columns */
  prifile_user_by_pk?: Maybe<Prifile_User>;
...
export type Query_RootPrifile_UserArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
export type Query_RootPrifile_User_AggregateArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
export type Query_RootPrifile_User_By_PkArgs = {
  id: Scalars['uuid'];
};
...
export type Subscription_RootPrifile_UserArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
export type Subscription_RootPrifile_User_AggregateArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
export type Subscription_RootPrifile_User_By_PkArgs = {
  id: Scalars['uuid'];
};
...
/** columns and relationships of "users" */
export type UsersPrifile_UsersArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
/** columns and relationships of "users" */
export type UsersPrifile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Prifile_User_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Prifile_User_Order_By>>;
...
export enum Users_Constraint {
  ...
  /** unique or primary key constraint */
  UsersPrifileIdKey = 'users_prifile_id_key'
}
